    ...
    <div ref={sectionRef}>
      ...
      >
        <motion.div
          ...
          className="pointer-events-none absolute left-1/2 top-0 h-[380px] w-[380px] -translate-x-1/2 rounded-full bg-emerald-300/20 blur-[120px]"
        />
        ...
        <Container size="wide" className="relative">
          ...
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-slate-600">
              Real-world impact delivered through intelligent air monitoring
              across schools, hospitals, workplaces and public spaces.
            </p>
          </div>
