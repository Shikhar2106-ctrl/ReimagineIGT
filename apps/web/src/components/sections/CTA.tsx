...
export default function CTA() {
  return (
    <Section size="spacious">
      <Container>
        <FadeIn>
          <div className="relative overflow-hidden rounded-panel border border-accent/20 bg-linear-to-br from-brand via-brand-dark to-surface px-8 py-20 text-center text-white lg:px-20 lg:py-28">
            ...
            <div className="relative z-10">
              <h2 className="mx-auto max-w-4xl text-balance text-4xl font-bold leading-tight lg:text-6xl">
                {ctaContent.title}
              </h2>
